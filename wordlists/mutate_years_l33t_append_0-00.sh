...
#echo "# Genereting $1_append"
#john -w:$1 -ru:netr_append -stdout > $1_append
...
echo "# [2/6] Genereting $1_l33t_append"
#john -w:$1_s7 -ru:netr_append -stdout > $1_l33t_append 2>/dev/null
john -w:$1_s7 -ru:netr_append_0-00 -stdout > $1_l33t_append 2>/dev/null
...
echo "# [5/6] Genereting $1_L33t_append"
john -w:$1_l33t_append_0-00 -ru:netr_cap -stdout > $1_L33t_append 2>/dev/null
echo "# [6/6] Genereting $1_L33t_years"
john -w:$1_l33t_years -ru:netr_cap -stdout > $1_L33t_years 2>/dev/null
#john -w:$1_append -ru:netr_cap -stdout > $1_Append
#john -w:$1_years -ru:netr_cap -stdout > $1_Years
rm $1_s7 $1_l33t_years $1_l33t_append
...
echo "# Concatenate $1_L33t $1_L33t_append"
cat $1_L33t $1_L33t_append > $1_a3
